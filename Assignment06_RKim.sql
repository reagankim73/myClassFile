...
-- 2017-01-01,reagan kim,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_RKim')
	 Begin 
	  Alter Database [Assignment06DB_RKim] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_RKim;
	 End
	Create Database Assignment06DB_RKim;
End Try
Begin Catch
	Print Error_Number();
End Catch
...
create View vIntengoriesByProductsByDates
as 
	Select top 1000000
	P.ProductName,
	I.InventoryDate,
...
Create view vInventoriesForChaiAndChangeByEmployees
as
	Select top 1000000
	C.CategoryName,
	P.ProductName,
